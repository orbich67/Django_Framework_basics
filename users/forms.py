...
class UserRegistrationForm(UserCreationForm):
    ...
    age = forms.IntegerField(widget=forms.TextInput(attrs={
        'class': 'form-control py-4', 'placeholder': 'Введите ваш возраст'}))
...
class UserOtherProfileForm(forms.ModelForm):
    tagline = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control py-4'}))
    aboutMe = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control py-4'}))
